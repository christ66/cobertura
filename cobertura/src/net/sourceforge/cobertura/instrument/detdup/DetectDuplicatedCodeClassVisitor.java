 ...
 * (see {@link CodeFootstamp} cryteria of 'identity').</p>  
 * 
...
public class DetectDuplicatedCodeClassVisitor extends ClassAdapter{
	...
	public MethodVisitor visitMethod(int access, String methodName,String description,String signature, String[] exceptions) {
		...
		DetectDuplicatedCodeMethodVisitor detectDuplicatedCodeClassVisitor=new DetectDuplicatedCodeMethodVisitor(nestedVisitor,duplicatedLinesCollector,className,methodName,description,lineIdGenerator);
		return detectDuplicatedCodeClassVisitor;
	}
